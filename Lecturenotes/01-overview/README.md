...
Như vậy, kỹ thuật lập trình phụ thuộc vào trí tuệ con người. Một chương trình tốt cần thỏa mãn các yêu cầu sau:

** Từ góc độ người dùng: **

- Chính xác: Chương trình giải quyết được các yêu cầu đặt ra của bài toán.
- Ổn định, tin cậy.
- Giao diện thân thiện.

** Từ góc độ người lập trình: **
